...
class MainActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    colorController = findViewById<SeekBar>(R.id.seekBar)
    colorGreenController = findViewById<SeekBar>(R.id.seekBarGreen)
    colorBlueController = findViewById<SeekBar>(R.id.seekBarBlue)
  ...
  private fun changColor() {
    ...
    colorController.setOnSeekBarChangeListener(
    ...
    colorBlueController.setOnSeekBarChangeListener(
      object : SeekBar.OnSeekBarChangeListener {
        override fun onProgressChanged(p0: SeekBar?, p1: Int, p2: Boolean) {
          colorBlue = p1
          tvTarget.setTextColor(Color.rgb(colorRed, colorGreen, colorBlue))
    ...
    colorGreenController.setOnSeekBarChangeListener(
      object : SeekBar.OnSeekBarChangeListener {
        override fun onProgressChanged(p0: SeekBar?, p1: Int, p2: Boolean) {
          colorGreen = p1
          tvTarget.setTextColor(Color.rgb(colorRed, colorGreen, colorBlue))
