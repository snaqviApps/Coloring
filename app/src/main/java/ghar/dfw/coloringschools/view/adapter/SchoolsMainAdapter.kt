...
class SchoolsMainAdapter(val schools: List<SchoolsBasicInfo>?,
                         private val clickListener: SchoolsBasicInfoListener) :
  RecyclerView.Adapter<SchoolsMainAdapter.SchoolsMainViewHolder>() {
  ...
  class SchoolsMainViewHolder(private val binding: ItemSchoolsBasicInfoBinding) :
  ...
  class SchoolsBasicInfoListener(val clickListener: (school: String) -> Unit) {
    fun onClick(schoolClicked: TextView) = clickListener(schoolClicked.text.toString())
  }
